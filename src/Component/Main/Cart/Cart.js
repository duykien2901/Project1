    ...
    render() {
        ...
        <>
            ...
            <div className="cart-title">
                <svg
                style={{ fill: "#fff", width: "36px", height: "auto" }}
                id="Capa_1"
                x="0px"
                y="0px"
                viewBox="0 0 512 512"
                ...
                <h1>Shop Cart ({cart.length})</h1>
            </div>
            </div>
            <CartDetail setMyCart = {this.props.setMyCart} cart = {this.props.cart} setTotalMyCart = {this.props.setTotalMyCart}/>
        </>
        );
    }
}
